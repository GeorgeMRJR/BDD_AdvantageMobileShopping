...
Funcionalidade: Cadastro de novo usuario
  ...
  Esquema do Cenario: cadastro positivo
    ...
    Exemplos: Deve preencher todos os campos e efetuar cadastro com sucesso
      ...
      | George70        | Abc123  | Abc123        | george@test.com | George | Luiz      | 989999899 | Brazil     | Sorocaba | SP     | Av.Gal   | 18060501 |
      | Joao70          | Abc1236 | Abc1236       | joao@test.com   | joao   | da silva  | 898777877 | Japan      | Tokyo    | Tokyo  | Av.Meiji | 18060501 |

  @TesteNegativo
 Esquema do Cenario: cadastro negativo
    E Digito o nome de usuario ja existente "<NomeDeUsuario>"
    E Digito o email "<Email>"
    E Digito a senha "<Senha>"
    E Digito a comfirmacao da senha "<ComfirmaSenha>"
    E Digito o primeiro nome "<Nome>"
    ...
    Exemplos: cadastro negativo
      ...
      | Joao          | Abc1236 | Abc1236       | joao@test.com   | joao   | da silva  | 898777877 | Japan      | Tokyo    | Tokyo  | Av.Meiji | 18060501 |
